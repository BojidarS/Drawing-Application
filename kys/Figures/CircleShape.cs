...
namespace Draw.Figures
{
    ...
    {
        [JsonConstructor]
        public CircleShape(Point startPoint, Point endPoint, Pen pen, Graphics g, Graphics graph, string shapeName, string penColor) : base(startPoint, endPoint, shapeName, penColor)
        {
