...
namespace Draw.Figures
{
    ...
    {
        [JsonConstructor]
        public CircleShape(Point startPoint, Point endPoint, Graphics g, Graphics graph, string shapeName, string penColor, float penWidth) : base(startPoint, endPoint, shapeName, penColor, penWidth)
        {
